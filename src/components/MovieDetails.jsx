...
// ===================== MOVIE DETAILS MAIN PAGE =========================
const MovieDetails = () => {
  const navigate = useNavigate();
  const dispatch = useDispatch();
  const { id } = useParams();

  const { info, loading } = useSelector((state) => state.movie);
  ...
  return (
    <div
      className="relative w-full px-[10%] pt-10 pb-20 text-white"
      style={{
        backgroundImage: bg
          ...
          <div className="max-w-[55%]">
            ...
            <h1 className="text-5xl font-black leading-tight">
              ...
              <span className="text-3xl font-light opacity-70">
                {" "}
                ({detail.release_date?.split("-")[0] || "N/A"})
              </span>
            </h1>
            ...
            <div className="flex items-center gap-6 mt-6">
              ...
              <span className="opacity-80">{detail.release_date}</span>
